...
const X99mark1 = ({setCartItems,handleCartState}) => {
  ...
  const addToCart = () => {
    ...
    console.log(`Adding ${itemCount} item(s) to cart`);
  ...
  return (
    ...
    <div className='flex justify-center'>
     ...
     <p className='md:hidden text-black font-bold mt-5 mb-5'>$1750</p>
      <div className=' md:hidden flex flex-row mb-20'>
        ...
        <button   onClick={decreaseQuantity}  className='bg-gray-300 py-2 px-3'> - 
          
        </button>
        <button onClick={resetQuantity} className='bg-gray-300 py-2 px-3 '>     
          {itemCount}
          </button>
          <button  onClick={increaseQuantity} className='bg-gray-300  py-2 px-3 mr-3'>  +
          
          </button>
        
        <p onClick={addToCart}  className='bg-orange-main
         text-white px-5  py-2 '>ADD TO
        CART</p>
      </div>
    ...
    <img src={xx99mark1lg} className='hidden sm:hidden md:hidden lg:block w-3/4 mx-auto'/>
    </div>
 ...
 <h4 className='text-orange-500 text-sm -tracking-wide line-height-12 flex mt-3  justify-start'>NEW PRODUCT</h4>
    ...
    As the gold standard for headphones,
       ...
       <div className='hidden sm:hidden md:block  mb-20'>
        ...
        <button className='bg-orange-main text-white px-7  py-2 '>ADD TO 
        CART</button>
       </div>
      </div>
      </div>
