...
const Headphones = () => {
  return (
    ...
    <div className='flex mt-10 space-x-9 mb-10'>
     ...
     <div className='hidden sm:hidden md:hidden lg:block flex flex-col mr-7 justify-center items-center'>
        ...
        <div className='flex flex-row space-x-9'>
         ...
         <div className='hidden sm:hidden md:hidden lg:block  mb-10'>
          ...
          <div className='relative bg-white mt-40'>
            <div className='flex justify-center'>
        <img className='w-3/4 -mt-20 border rounded-lg' src={xx99mark1} alt="Product Image 1" />
        </div>
      ...
      <div className='flex justify-center'>
  <img  className=' -p-10 w-3/4 border rounded-lg 
  ...
  <img className='w-3/4  -mt-15 border rounded-lg' src={yx1} alt="Product Image 2" />
