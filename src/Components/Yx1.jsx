...
const Yx1 = ({addToCart,removeFromCart}) => {
  return (
    <div className='w-3/4 mx-auto'>
        ...
        <p className='md:hidden lg:hidden font-light  mb-5'>
    ...
    <img src={YX1earlg} className='hidden sm:hidden md:hidden lg:block w-3/4 mx-auto'/>
    </div>
 ...
 <h4 className='text-orange-500 text-sm -tracking-wide line-height-12 flex mt-3  justify-start'>NEW PRODUCT</h4>
    ...
    <p className='flex justify-center items-center'>
       ...
       <div className='hidden sm:hidden md:block  mb-20'>
        ...
        <button className='bg-gray-300 py-3 px-5'> - 
...
<div className='relative max-w-xs mx-auto bg-white mt-20 '>
<div className='border rounded-lg overflow-hidden relative'>
...
<div className='relative max-w-xs mx-auto bg-white mt-20 mb-20 '>
<div className='border rounded-lg overflow-hidden relative'>
<img className='md:hidden lg:hidden max-w-full h-auto 
